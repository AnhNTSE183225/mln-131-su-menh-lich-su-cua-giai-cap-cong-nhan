...
export function ChatBubble() {
    ...
    return (
        <>
            {/* Chat Window */}
            {isOpen && (
                <Card className="fixed bottom-24 right-4 w-[calc(100vw-2rem)] max-w-xl sm:max-w-2xl shadow-lg z-50 flex flex-col max-h-[80vh]">
                                                                                        ...
                                                                                        <ReactMarkdown
                                                                                            ...
                                                                                            components={{
                                                                                                                                                    p: ({node, ...props}) => <p {...props}
                                                                                                                                                                                        className="my-1 last:mb-0 text-xs"/>,
                                                                                                                                                    ul: ({node, ...props}) => <ul {...props}
                                                                                                                                                                                          className="my-2 list-disc pl-4 text-xs"/>,
                                                                                                                                                    ol: ({node, ...props}) => <ol {...props}
                                                                                                                                                                                          className="my-2 list-decimal pl-4 text-xs"/>,
                                                                                                                                                    li: ({node, ...props}) => <li {...props} className="my-0 text-xs"/>,                                                                                            }}
                                                                                        >
                                                                                            {message.text}
                                                                                        </ReactMarkdown>
                                                                                    </div>
                                                                                ) : (
                                                                                    <p className="text-xs whitespace-pre-line text-white">{message.text}</p>
                                                                                )}
