              ...
              <div className="space-y-4">
                {messages.map((message) => (
                  ...
                  >
                    ...
                    >
                      {message.sender === 'bot' ? (
                        <div className="prose prose-sm max-w-none text-black prose-headings:text-black prose-headings:mb-1 prose-p:my-1 prose-ul:my-1 prose-ol:my-1 prose-li:my-0">
                          <ReactMarkdown
                            remarkPlugins={[remarkGfm]}
                            components={{
                              p: ({ node, ...props }) => <p {...props} className="my-1 last:mb-0" />,
                              ul: ({ node, ...props }) => <ul {...props} className="my-2 list-disc pl-4" />,
                              ol: ({ node, ...props }) => <ol {...props} className="my-2 list-decimal pl-4" />,
